...
In JavaScript, we use three keywords to declare variables: _var_, _let_, and _const_. While _var_ has been around for a long time, _let_ and _const_ were introduced in ES6 to provide more flexible and reliable variable scoping.
